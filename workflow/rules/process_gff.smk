rule crate_ordered_gff_genes_table:
    input:
    ...
    log:
        log = 'log/crate_ordered_gff_genes_table.log'
    conda:
        '../envs/basic.yaml'
    script:
...
rule create_synteny_counts_table:
    input:
        ...
        ordered_gff_genes = rules.crate_ordered_gff_genes_table.output.ordered_gff_genes
    output:
