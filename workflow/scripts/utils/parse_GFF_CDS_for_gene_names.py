...
directory = os.fsencode('/media/lruzzant/DATA/evol-feat-data-processing/GFFs_CDS/')
out_directory = os.fsencode('/media/lruzzant/DATA/evol-feat-data-processing/GFFs_CDS_ODB/')
