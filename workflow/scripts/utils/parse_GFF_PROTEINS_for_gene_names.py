...
directory = os.fsencode('/media/lruzzant/DATA/evol-feat-data-processing/GFFs_PROTEINS/')
out_directory = os.fsencode('/media/lruzzant/DATA/evol-feat-data-processing/GFFs_PROTEINS_ODB/')
