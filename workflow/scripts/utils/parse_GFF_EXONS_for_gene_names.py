...
directory = os.fsencode('/media/lruzzant/DATA/evol-feat-data-processing/GFFs_EXONS/')
out_directory = os.fsencode('/media/lruzzant/DATA/evol-feat-data-processing/GFFs_EXONS_ODB/')
