...
AGAP2GOStopGO <- read.delim("moz2_GO/AGAP2GOS-topGO_dataframe.tsv", header=FALSE)
colnames(AGAP2GOStopGO) <- c('gene_id', 'GO.term')
df <- merge(gene_2_og_2_sommap, AGAP2GOStopGO, by = 'gene_id')
...
## WRITING OUTPUT FILE
write.table(df, file = 'moz2_GO/AGAP2GOS-topGO_2_somcells.tsv',
